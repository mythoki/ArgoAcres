...
=======
  void showCropInfo(){
    ...
    textSize(15);
    text("Oats also prefer warm, sunny weather with moderate rain. They grow best in fertile, well-drained soil.", indent, height/3+nextTitle);  
    text("They should be planted during late summer and harvested in mid-summer of the following year.", indent, height/3+nextLine+nextTitle);
    ...
    textSize(15);
    text("Wheat grows best in warm temperatures with moderate rain.", indent, (height/2)+nextTitle);
    text("They should be planted in clay loam in spring or fall to be harvested in the summer.", indent, (height/2)+nextLine+nextTitle); 
    
  } 
>>>>>>> a97c795bd96e1d57207cf0076336f7087d9b3708
}
